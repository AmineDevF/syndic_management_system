...
<div class="container-fluid">
    {{-- <div class="row">
       <div class="col-12">
          <div class="card-box">
             <h4 class="header-title mb-4">Statut Actuel</h4>
             <div class="row">
             ...
             <div class="table-responsive">
                <table class="table table-hover table-centered m-0">
                   ...
                   <tbody>
                      ...
                      <tr>
                         <td>
                            <img src="{{asset('assets/images/users/avatar-3.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                         </td>
                         <td>
                      ...
                      <tr>
                         <td>
                            <img src="{{asset('assets/images/users/avatar-4.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                         </td>
                         <td>
                      ...
                      <tr>
                         <td>
                            <img src="{{asset('assets/images/users/avatar-5.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                         </td>
                         <td>
                      ...
                      <tr>
                         <td>
                            <img src="{{asset('assets/images/users/avatar-6.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                         </td>
                         <td>
